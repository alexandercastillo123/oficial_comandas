...
export default function PerfilScreen() {
  ...
  const loadEstadoAsistencia = async () => {
    try {
      ...
      console.log('Error al obtener estado de asistencia diaria para admin:', err);
    }
  };
    ...
    >
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        ...
        {estadoAsistencia?.turno ? (
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>Horario de Trabajo</Text>
            <Text style={styles.noTurnoText}>Sin turno de trabajo asignado hoy. Configure uno en Trabajadores.</Text>
          </View>
        )}
